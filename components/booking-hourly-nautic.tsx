...
const CONFIG_EMPRESA: EmpresaConfig = {
  nombreComercial: "Charter Nautico Premium",
  subtitulo: "Generador de bonos digitales para venta directa",
  etiqueta: "Gran Canaria Collection",
  claim: "Vende bonos regalo en menos de 30 segundos",
  descripcion: "Cobro instantaneo con Stripe y ticket digital para canje flexible.",
  servicioEstrella: "Paseo Privado en Barco",
  prefijoCodigo: "AQUA",
  precioBono: 129,
  validezMeses: 12,
};

export function BookingHourlyNautic() {
  ...
  const applyDemoAutofill = async () => {
    ...
    if (voucherType === "regalo") {
      ...
      setGiftMessage("Regalo esta experiencia para disfrutar cuando quieras.");
    }
  ...
  const payNow = async () => {
    ...
    try {
      ...
      if (isTestMode) {
        ...
        window.location.href = `/actividades/exito?${qs.toString()}`;
        return;
      }

      const res = await fetch("/api/stripe/checkout/activities", {
        method: "POST",
      ...
      <div className="mx-auto w-full space-y-4">
        <div className="relative h-52 w-full overflow-hidden rounded-3xl border border-cyan-200/70 shadow-2xl sm:h-64">
          <div
            ...
            style={{
              backgroundImage: "url('https://thisisgrancanaria.com/wp-content/uploads/2024/09/maxresdefault-7.jpg')",
            }}
          />
          ...
          <CardContent className="space-y-4">
            ...
            <div className="rounded-xl border border-cyan-200 bg-white p-4">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Bono valido por {CONFIG_EMPRESA.validezMeses} meses. Tras la compra, recibiras un codigo para canjear
                cuando quieras.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              >
                ...
                <p className="mt-1 text-sm text-slate-600">Perfecto para regalar una experiencia premium.</p>
              </button>
              ...
              >
                ...
                <p className="mt-1 text-sm text-slate-600">Compra ahora y canjea la fecha mas adelante.</p>
              </button>
            </div>

            <div>
              <Label htmlFor="quantity">Cantidad de bonos</Label>
              <Input
                id="quantity"
                type="number"
                min={1}
            ...
            {isTestMode ? (
              <div className="rounded-xl border border-cyan-200 bg-cyan-50 p-3 text-xs text-cyan-900">
                ...
                <p>
                  Demo 1-click habilitada. Tambien puedes compartir: 4242 4242 4242 4242 / 12-26 / 123 / 35001.
                </p>
              </div>
            ) : null}
            ...
            {isTestMode ? (
              <p className="text-center text-xs font-medium text-cyan-900">
